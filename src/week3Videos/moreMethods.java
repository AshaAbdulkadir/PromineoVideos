...
public class moreMethods {
	...
	public static void main(String[] args) {
		...
		//you can only pass int as it is what its asking for and not String or any other data type 
	...
	/*
	 * Takes an array of double and return the average of all elements in the array
	 */
