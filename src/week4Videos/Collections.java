...
public class Collections {
	...
	public static void main(String[] args) {
		// collects: lists, maps, set
		
		/*
		 * Lists
		 * allows duplicates
		 * keeps elements orderedd by index
		 * allows null values
		 ...
		 * No duplicates
		 * unordered 
		 * allows only one nul as it does not allow duplicates
		...
		System.out.println(states.contains("Ohio")); //prints true or false
		states.remove("Alabama"); // if statesment for the same: if(states.contains("Alabama")){states.remove("Alabama")}
		 ...
		 * common implemetation: HashMap, LinkedHashMap, TreeMap, HashTable
		 */
		...
		dictionary.put("Argument", "given to expressing divergent or opposite views.");
